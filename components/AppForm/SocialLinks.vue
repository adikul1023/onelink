<template>
  ...
  >
    <div class="shadow sm:overflow-hidden sm:rounded-md">
      <div class="grid grid-cols-2 gap-8 bg-white dark:bg-slate-800 px-4 py-5 sm:p-6">
        <div>
          <label for="facebook" class="block text-sm font-medium text-gray-700 dark:text-slate-300"
            >Facebook</label
          >
          <div class="mt-1 flex rounded-md shadow-sm">
            <span
              class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-700 px-3 text-sm text-gray-500 dark:text-slate-400"
            >
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://fb.com/elonmusk"
            />
          </div>
        </div>
        <div>
          <label for="twitter" class="block text-sm font-medium text-gray-700 dark:text-slate-300"
            >Twitter</label
          >
          <div class="mt-1 flex rounded-md shadow-sm">
            <span
        ...
        <div>
          <label for="instagram" class="block text-sm font-medium text-gray-700 dark:text-slate-300"
            >Instagram</label
          >
          <div class="mt-1 flex rounded-md shadow-sm">
            <span
